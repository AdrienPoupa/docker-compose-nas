...
| [Home Assistant](https://www.home-assistant.io)                    | Optional - Open source home automation that puts local control and privacy first<br/>Enable with `COMPOSE_PROFILES=homeassistant`                    | [home-assistant/home-assistant:stable](https://ghcr.io/home-assistant/home-assistant)    |              |
| [Immich](https://immich.app)                                       | Optional - Self-hosted photo and video management solution<br/>Enable with `COMPOSE_PROFILES=immich`                                                 | [immich-app/immich-server:release](https://ghcr.io/immich-app/immich-server)             |              |
| [Cabernet](https://cabernetwork.github.io/)                                       | Optional - Web app which allows you to be in control of the IPTV streams.<br/>Enable with `COMPOSE_PROFILES=cabernet`                                                 | [cabernetwork/cabernet:release](https://ghcr.io/cabernetwork/cabernet)             |              |
| [Free IPTV Channels](https://cabernetwork.github.io/)                                       | Optional - Web app which retrieves m3u files according with settings.<br/>Enable with `COMPOSE_PROFILES=iptv`                                                 | [arbupo/free-iptv-channels:release](https:/ghcr.io/arbupo/free-iptv-channels)             |              |
| [Calibre-Web](https://github.com/janeczku/calibre-web)             | Optional - Web app for browsing, reading and downloading eBooks stored in a Calibre database<br/>Enable with `COMPOSE_PROFILES=calibre-web`          | [linuxserver/calibre-web](https://hub.docker.com/r/linuxserver/calibre-web)              | /calibre     |
| [Calibre-Web-Automated](https://github.com/crocodilestick/Calibre-Web-Automated)             | Optional - Web app for browsing, reading and downloading eBooks stored in a Calibre database<br/>Enable with `COMPOSE_PROFILES=calibre-web-automated`          | [crocodilestick/calibre-web-automated](https://hub.docker.com/r/crocodilestick/calibre-web-automated)              | /cwa     |
| [Calibre-Web-Automated-Book-Downloader](https://github.com/calibrain/calibre-web-automated-book-downloader)             | Optional - Web app for downloading books<br/>Enable with `COMPOSE_PROFILES=cwabd`          | [crocodilestick/calibre-web-automated](https://ghcr.io/calibrain/calibre-web-automated-book-downloader)              | /cwabd     |
...
| [Prometheus](https://github.com/prometheus/prometheus)             | Optional - Systems and service monitoring system. It collects metrics from configured targets at given intervals, evaluates rule expressions, displays the results, and can trigger alerts when specified conditions are observed.<br/>Enable with `COMPOSE_PROFILES=prometheus`          | [prom/prometheus](https://hub.docker.com/r/prom/prometheus)              |      |
...
| `DATA_ROOT_NOBRL`                    | Host location of the data files for volumes that need rw access to databases                                                                                                                                                                        | `/mnt/data_nobrl`                                      |
| `DOWNLOAD_ROOT_NOBRL`                | Host download location for qBittorrent, should be a subfolder of `DATA_ROOT_NOBRL`                                                                                                                           | `/mnt/data_nobrl/downloads`                             |
...
| `DOMAIN`                     | Hostname of the NAS, could be a local IP or a domain (not include www)name                                                                                                                                              | `test.com`                                      |
| `CABERNET_SUBDOMAIN`                     | Subdomain to access cabernet name                                                                                                                                              | `cabernet`                                      |
| `CWA_SUBDOMAIN`                     | Subdomain to access calibre web automated name                                                                                                                                              | `cwa`                                      |
